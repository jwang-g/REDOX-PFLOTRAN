...
decomp_network.decomp_pool(name='DOM1',CN=50,constraints={'initial':7e-4,'sed_air_interface':6.5e-4,'excretion':1e-20,'tide':1e-2,'sed_water_interface':1e-3},kind='primary'),
...
decomp_network.decomp_pool(name='O2(aq)',kind='primary',constraints={'initial':1e-4,'sed_air_interface':1e-3,'excretion':1e-20,'tide':1e-2,'sed_water_interface':1e-5}),
...
decomp_network.decomp_pool(name='Fe+++',kind='primary',constraints={'initial':1e-5,'sed_air_interface':1e-6,'excretion':1e-20,'tide':1e-20,'sed_water_interface':1e-15}),
decomp_network.decomp_pool(name='Fe++',kind='primary',constraints={'initial':1e-8,'sed_air_interface':1e-8,'excretion':1e-20,'tide':1e-20,'sed_water_interface':1e-10}),

decomp_network.decomp_pool(name='NH4+',kind='primary',constraints={'initial':1e-9,'sed_air_interface':1e-9,'excretion':1e-20,'tide':1e-6,'sed_water_interface':1e-7}), # SOMDecomp sandbox requires this
decomp_network.decomp_pool(name='NO3-',kind='primary',constraints={'initial':1e-5,'sed_air_interface':1e-4,'excretion':1e-20,'tide':1e-6,'sed_water_interface':1e-6}),
...
decomp_network.decomp_pool(name='H2S(aq)',kind='secondary',constraints={'initial':1e-5,'sed_air_interface':1e-6,'excretion':1e-20,'tide':1e-8,'sed_water_interface':1.5e-6}),
decomp_network.decomp_pool(name='Acetate-',kind='primary',constraints={'initial':7e-4,'sed_air_interface':6.5e-4,'excretion':1e-20,'tide':1e-2,'sed_water_interface':1e-3}),
...
decomp_network.decomp_pool(name='HS-',kind='primary',constraints={'initial':1e-15,'sed_air_interface':1e-15,'excretion':1e-20,'tide':1e-15,'sed_water_interface':1e-15}),
...
#	                                            rate_constant=rate_scale,reactiontype='MICROBIAL'),
	    ...
	    decomp_network.reaction(name='Acetoclastic methanogenesis',stoich='1.0 Acetate- -> 1.0 CH4(aq) + 1.0 HCO3- + 1.0 Tracer',
	                                            monod_terms=[decomp_network.monod(species='Acetate-',k=conc_scales['Acetate-']*3,threshold=thresh),],
	    ...
	    decomp_network.reaction(name='Hydrogenotrophic methanogenesis',stoich='4.0 H2(aq) + 1.0 HCO3- + 1.0 H+ -> 1.0 CH4(aq) + 3.0 H2O',
	                                            monod_terms=[decomp_network.monod(species='H2(aq)',k=conc_scales['H2(aq)']*0.1,threshold=thresh),decomp_network.monod(species='HCO3-',k=conc_scales['HCO3-'],threshold=thresh)],
	    ...
	    decomp_network.reaction(name='Sulfate reduction',stoich='1.0 Acetate- + 1.0 SO4--  -> 2.0 HCO3- + 2.0 HS- +  2.0 Tracer',
	                                            monod_terms=[decomp_network.monod(species='Acetate-',k=conc_scales['Acetate-']*0.1,threshold=thresh),decomp_network.monod(species='SO4--',k=conc_scales['SO4--'],threshold=thresh)],
	                                            inhibition_terms=[decomp_network.inhibition(species='O2(aq)',k=conc_scales['O2(aq)'],type='MONOD'),
	                                                                decomp_network.inhibition(species='NO3-',k=conc_scales['NO3-'],type='MONOD'),
	                                                                decomp_network.inhibition(species='Fe+++',k=conc_scales['Fe+++'],type='MONOD')],
	                                            rate_constant=rate_scale,reactiontype='MICROBIAL'),
...
if __name__ == '__main__':
    ...
    networkfig=pyplot.figure('Reaction network',clear=True,figsize=(7.1,8.9));networkfig.clf()
